...
(function () {
    ...
    gpii.request.flowManager.onUserLogin = function (userToken, handler, flowManager) {
    ...
    gpii.request.flowManager.startLifecycle = function (flowManager, lifecycleManager, lifecyclePayload, sessionData, event) {
        // flowManager.pcpInterface.sendUserMessage("HALLO");
            ...
            gpii.request.flowManager.logAndNotify("Lifecycle manager returned: ", event, function () {
                flowManager.pcpInterface.sendUserMessage({
                    ...
                    message: {
                        ...
                        en: "User " + sessionData.userToken + " successfully logged in",
    ...
    fluid.defaults("kettle.requests.request.handler.userLogin", {
        ...
        invokers: {
            ...
            handle: {
                ...
                args: ["{request}.req.params.userToken", "{that}", "{flowManager}"],
                dynamic: true
            },
            runContextManager: {
