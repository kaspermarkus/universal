...
gpii.tests.flowManager.PCPInterface.checkConnectionRequest = function (data, client) {
    ...
    client.socket.on("message", function (a, b) {
        console.log("Message event received: " + JSON.stringify(a));
        client.events.onMessage.fire(a, b)
    });
};
        ...
        sequence: [
            {
                ...
                args: [
                    "{arguments}.0", {
                        type: "warningMessage",
                        message: "I should not be triggered"
                    }
                ]
            }, {
