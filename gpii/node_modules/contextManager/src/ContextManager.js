...
(function () {
    ...
    fluid.defaults("gpii.contextManager", {
        ...
        invokers: {
            ...
            dispatchToPCP: {
                funcName: "gpii.contextManager.dispatchToPCP",
    ...
    gpii.contextManager.evaluateMatch = function (that, matchedData, toSession, event) {
        ...
        that.dispatchToPCP(toSession.appliedConfiguration.metadata);
    ...
    gpii.contextManager.dispatchToPCP = function (flowManager, metadata) {
        fluid.each(metadata, function (md) {
            if (md.type === "PCPPopulation") {
                // flowManager.pcpInterface.setContent(md.settings);
            } else if (md.type === "infoMessage") {
                flowManager.pcpInterface.sendUserMessage(md)
            } else if (md.type === "helpMessage") {
                flowManager.pcpInterface.sendUserMessage(md)
            }
        });
    };
